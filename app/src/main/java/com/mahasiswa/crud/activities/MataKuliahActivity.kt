...
import com.mahasiswa.crud.databinding.ActivityMataKuliahBinding
...
class MataKuliahActivity : AppCompatActivity() {
    ...
    private fun showComingSoonMessage() {
        binding.tvEmpty.text = "Mata Kuliah module - Coming Soon!"
        binding.tvEmpty.visibility = android.view.View.VISIBLE
        binding.fabAdd.setOnClickListener {
            Toast.makeText(this, "Mata Kuliah CRUD akan segera tersedia", Toast.LENGTH_SHORT).show()
        }
    }
